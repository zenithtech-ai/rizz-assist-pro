# Rizz Assist Admin Dashboard

Complete admin dashboard for managing Rizz Assist Pro users, costs, and analytics.
...
# Then clone it
git clone https://github.com/YOUR_USERNAME/rizz-assist-admin.git
cd rizz-assist-admin
```

### 2. Copy Files

Copy all the admin dashboard files (provided below) into your cloned repository.

### 3. Install & Deploy to Vercel
...
3. Add environment variables:
   ...
   - `NEXT_PUBLIC_SUPABASE_ANON_KEY`: (copy from your app's .env)
4. Deploy
...
Below are all the files you need to create in your GitHub repository:
...
1. **Create GitHub Repository**
   ...
   - Create `rizz-assist-admin` (private recommended)
...
4. **Your admin dashboard is live!**
   - Visit `https://rizz-assist-admin.vercel.app`
   - See all your users, costs, and analytics in real-time
